                    ...
                    <div class="left-side">
                        ...
                        <nav id="navigation" class="style-1">
                            ...
                            <li><a href="#" <?php if ($subnav == 'blog' || $subnav == 'compare-properties' ): ?>
                                    class="current" <?php endif; ?>>Tiện Ích</a>
                                <ul>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5 col-sm-6">
                        ...
                        <br><br>
                        <p>Đây là tiểu luận phát triển bởi sinh viên<br> <strong
                                style="color: red; font-size: 20px">Đinh
                                Xuân Trường</strong>.<br>Cung cấp cho người dùng hệ thống đăng tin mua bán bất động sản
                            sử
