...
jQuery.migrateMute = !0, function (t) {
    ...
    var a, i = s.fn.init, c = s.isNumeric, d = s.find, l = /\[(\s*[-\w]+\s*)([~|^$*]?=)\s*([-\w#]*?#[-\w#]*)\s*\]/,
        p = /\[(\s*[-\w]+\s*)([~|^$*]?=)\s*([-\w#]*?#[-\w#]*)\s*\]/g;
    for (a in s.fn.init = function (e) {
        var t = Array.prototype.slice.call(arguments);
        return "string" == typeof e && "#" === e && (u("jQuery( '#' ) is not a valid selector"), t[0] = []), i.apply(this, t)
    ...
    }, d) Object.prototype.hasOwnProperty.call(d, a) && (s.find[a] = d[a]);
    s.fn.size = function () {
    ...
    s.swap && s.each(["height", "width", "reliableMarginRight"], function (e, t) {
        ...
        var o, a, i = {};
        for (a in g || u("jQuery.swap() is undocumented and deprecated"), t) i[a] = e.style[a], e.style[a] = t[a];
    ...
    s.data = function (e, t, r) {
        ...
        if (t && "object" == typeof t && 2 === arguments.length) {
            ...
            var o = {};
            for (var a in t) a !== s.camelCase(a) ? (u("jQuery.data() always sets/gets camelCased names: " + a), n[a] = t[a]) : o[a] = t[a];
    ...
    s.event.props = [], s.event.fixHooks = {}, t(s.event.props, "concat", s.event.props.concat, "jQuery.event.props.concat() is deprecated and removed"), s.event.fix = function (e) {
        ...
        if (n && !n._migrated_ && (n._migrated_ = !0, u("jQuery.event.fixHooks are deprecated and removed: " + r), (o = n.props) && o.length)) for (; o.length;) s.event.addProp(o.pop());
    ...
    var R = s.Deferred,
        H = [["resolve", "done", s.Callbacks("once memory"), s.Callbacks("once memory"), "resolved"], ["reject", "fail", s.Callbacks("once memory"), s.Callbacks("once memory"), "rejected"], ["notify", "progress", s.Callbacks("memory"), s.Callbacks("memory")]];
            ...
            return u("deferred.pipe() is deprecated"), s.Deferred(function (n) {
                s.each(H, function (e, t) {
                    ...
                    a[t[1]](function () {
                        ...
                        e && s.isFunction(e.promise) ? e.promise().done(n.resolve).fail(n.reject).progress(n.notify) : n[t[0] + "With"](this === i ? n.promise() : this, r ? [e] : arguments)
                    })
                }), o = null
            }).promise()
        }, e && e.call(a, a), a
    }, s.Deferred.exceptionHook = R.exceptionHook, s
});
